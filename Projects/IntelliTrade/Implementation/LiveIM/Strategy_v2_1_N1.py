...
def createActiveTradeDict(order_dict, margin_bandwidth, strike_price, quantity):
    ...
    # 
    active_trade_dict = {}
    active_trade_dict['instrument_ltp_T1'] = float(instrument_ltp_T1)
...
def saveTradeStatusToDisk():
    ...
    json_object = {
        ...
        'instrument_ltp_T1'   : float(instrument_ltp_T1),
    ...
    with open(os.path.join(directory_path, 'strategy_v2_1_N1_TradeState.json'), 'w+') as output_file:
...
def loadTradeStatusFromDisk():
    ...
    # 
    directory_path = parameter_dict['directory_path']
    with open(os.path.join(directory_path, 'strategy_v2_1_N1_TradeState.json'), 'r') as input_file:
...
def activeThreadsMonitoring():
    """
    """
    file_path = os.path.join(GOOGLEDRIVE_TRADE_LOGS_DIR, 'LIVE', 'ActiveThreadMonitoring', 'ActiveThreadsName_strategy_v2_1_N1.txt')
...
def initializeMainProcess():
    ...
    file_name = 'strategy_v2_1_N1'+'_'+datetime.now().strftime('%Y%m%d_%H%M%S')+'.log'
    logger = initializeLogger(directory_path=directory_path, file_name=file_name)
    # 
    parameter_dict = {
        'strategy_name'          : 'strategy_v2_1_N1',
        'instrument_name'        : 'NIFTY',
        'step_size'              : 100,
        'sell_trade_time'        : '0915',
        'buy_trade_time'         : '1524',
        'expiry_week_ahead'      : 0,
        'lower_strike_bandwidth' : 300,
        'upper_strike_bandwidth' : 300,
        'lower_margin_bandwidth' : 100,
        'upper_margin_bandwidth' : 100,
        'lower_margin_threshold' : 600,
        'upper_margin_threshold' : 600,
        ...
        'trade_start_time'       : '091805',
        'trade_end_time'         : '152800',
    }
...
strategy_v2_1_N1_MainThread_exitFlag = False
def strategy_v2_1_N1_MainThread():
    """
    """
    global strategy_v2_1_N1_MainThread_exitFlag
    ...
    # 
    while not strategy_v2_1_N1_MainThread_exitFlag:
        strategy_v2_1_N1_Main()
    ...
    logger.info('Exiting -> strategy_v2_1_N1_MainThread')
...
def shutdownAllThreads():
    ...
    global raiseNetworkErrorThread_exitFlag
    # 
    strategy_v2_1_N1_MainThread_exitFlag = True
...
strategy_v2_1_N1_MainThread_exitFlag = False
strategy_v2_1_N1_MainThread_thread = threading.Thread(target=strategy_v2_1_N1_MainThread, name='strategy_v2_1_N1_MainThread', daemon=True)
strategy_v2_1_N1_MainThread_thread.start()
...
import importlib
import LiveTradeUtilities
importlib.reload(LiveTradeUtilities)