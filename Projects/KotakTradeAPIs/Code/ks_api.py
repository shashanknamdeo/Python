...
class KSTradeApi():
    def __init__(self, access_token = access_token, userid = username, consumer_key = '7Sivw6iASSCFNNgQia16uhbUQ98a', ip = ip, app_id = '3PzkUybzXXZOftP5Ap5iV5mJ2NYa', host = "https://tradeapi.kotaksecurities.com/apim", proxy_url = '',\
    ...
    def login(self, password = '_Sknam28'):
